    ...
    <FormControl>
      ...
      >
        <div style={{ paddingTop: "10px" }}>
          <Typography sx={{ p: 2 }}>
            Hybrid Search combines product filters with vector similarity
            search.
          </Typography>
          <div
            style={{
          ...
          >
            <div>
              ...
              >
                <FormControlLabel
                  value="Women"
                  control={<Radio size="small" onClick={setProductGender} />}
                  label="Women"
                />
                <FormControlLabel
                  value="Men"
            ...
            <div>
              ...
              >
                <FormControlLabel
                  value="Apparel"
                  control={<Radio size="small" onClick={setProductCategory} />}
                  label="Apparel"
                />
                <FormControlLabel
                  value="Accessories"
